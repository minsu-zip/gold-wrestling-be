...
- [x] 04-06-PLAN.md — [TDD] 차감 대상 이용권 선택(만료 임박순·합산 금지·수업날 기준) (RESV-01/02/03)
...
- [x] 04-11-PLAN.md — 관리자 주간 스케줄 보드(셀별 예약자 명단) (SCHED-03)
...
**청크 A — 기반 (wave 1~2)**
- [ ] 06-01-PLAN.md — glossary·policies §4.2·decisions(D-132~135)·error-codes 정합 + ErrorCode 6종 + `EVENING_HALF_REFUND` (ATTEND-01/02, NOTICE-01, NOTIF-03)
- [ ] 06-02-PLAN.md — V11 스키마(attendance·notice·활동 피드 인덱스) + 엔티티·리포지토리 + 유니크/ATTENDED 필터 통합테스트 (ATTEND-01/02, NOTICE-01/02, NOTIF-03)
...
- [ ] 06-05-PLAN.md — [TDD] `EveningHalfDeductionPolicy` + `existsActiveEveningMembership` + 출석 예외 5종 (ATTEND-01/02)
