# Requirements Archive: v1.0 (M1~M6)

**Archived:** 2026-09-01 (milestone complete)
**Outcome:** v1 요구사항 44/44 전부 구현·검증 완료. 도중 조정 2건, 탈락 0건.

## 요구사항 변경 이력 (최초 정의 → 마감)

| 변경 | 내용 |
|---|---|
| 추가 | PASS-07·PASS-08 — Phase 3 논의로 추가 (2026-08-03). 42건 → 44건 |
| 의미 보강 | BATCH-01 — 기준일 3종 → 5종 max(D-105), 시행일 하한·실행 상한(D-119), CR-03 배선으로 완결(D-130) |
| 의미 보강 | BATCH-02 — 차감 예외 3종 → 4종(`INACTIVE` 추가, D-147 — v1 마감 결정) |
| 탈락/무효화 | 없음 |

## 원본 REQUIREMENTS.md (마감 시점 전문)
